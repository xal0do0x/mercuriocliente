 ...
 */
package com.biosis.mercurio.ansisdk;
...
public class AnsiSDKLib {
    ...
    public native boolean CreateTemplate(byte finger, byte[] pImage, byte[] pTemplate, int[] pTemplateSize);
    public native boolean VerifyTemplate(byte finger, byte[] pImage, byte[] pTemplate, float[] pVerifyResult);
    ...
    static 
    {
        System.load("C:\\Users\\Aldo\\Documents\\NetBeansProjects\\ftrAnsiSDKJni\\x64\\release\\ftrScanAPI.dll");
    	//System.loadLibrary("ftrScanAPI");
    }
	
    static 
    {
        System.load("C:\\Users\\Aldo\\Documents\\NetBeansProjects\\ftrAnsiSDKJni\\x64\\release\\ftrAnsiSdk.dll");
        //System.loadLibrary("ftrAnsiSDK");
    }
	
    static 
    {
        System.load("C:\\Users\\Aldo\\Documents\\NetBeansProjects\\ftrAnsiSDKJni\\x64\\release\\ftrAnsiSDKJni.dll");

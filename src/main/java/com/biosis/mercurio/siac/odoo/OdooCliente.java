 ...
 * @author fesqu
 */
public class OdooCliente extends XmlRpcClient{
     ...
     */
    public OdooCliente(String host, int port, RPCServices service) {
     ...
     * @param service OpenERP webservice to call (db/common etc)
     */
    public OdooCliente(RPCProtocol protocol, String host, int port,
            RPCServices service) {
        super();
